(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[3650],{
...
// EXTERNAL MODULE: ./node_modules/@strapi/plugin-upload/admin/src/utils/index.js + 4 modules
var utils = __webpack_require__(33407);
...
;// CONCATENATED MODULE: ./node_modules/@strapi/plugin-upload/admin/src/hooks/useFolder.js
...
const useFolder = (id, { enabled = true }) => {
  ...
  const dataRequestURL = (0,utils/* getRequestUrl */.IF)("folders");
  const fetchFolder = () => __async(void 0, null, function* () {
    try {
      const { data: data2 } = yield utils/* axiosInstance.get */.be.get(`${dataRequestURL}/${id}?populate=parent`);
      return data2.data;
    } catch (err) {
      toggleNotification({
        type: "warning",
        message: {
          id: (0,utils/* getTrad */.OB)("notification.warning.404"),
  ...
  const { data, error, isLoading } = (0,react_query_lib.useQuery)([pluginId/* default */.Z, "folder", id], fetchFolder, {
    retry: false,
    enabled,
    staleTime: 0,
    cacheTime: 0
...
const BulkDeleteButton = ({ selected, onSuccess }) => {
  ...
  const handleConfirmRemove = () => BulkDeleteButton_async(void 0, null, function* () {
...
// EXTERNAL MODULE: ./node_modules/@strapi/plugin-upload/admin/src/components/SelectTree/index.js + 5 modules
var SelectTree = __webpack_require__(76434);
...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, {
      ...
      id: (0,utils/* getTrad */.OB)("list.asset.load"),
...
const Header = ({
  ...
  const name = ((_c = folder == null ? void 0 : folder.name) == null ? void 0 : _c.length) > 30 ? `${folder.name.slice(0, 30)}...` : folder == null ? void 0 : folder.name;
  return /* @__PURE__ */ react.createElement(Layout.HeaderLayout, {
    ...
    subtitle: formatMessage(
      {
        id: (0,utils/* getTrad */.OB)("header.content.assets"),
...
Header.propTypes = {
  assetCount: (prop_types_default()).number.isRequired,
  canCreate: (prop_types_default()).bool.isRequired,
  folder: constants/* FolderDefinition */.nx,
  folderCount: (prop_types_default()).number.isRequired,
...
var __objRest = (source, exclude) => {
  ...
  for (var prop in source)
    if (MediaLibrary_hasOwnProp.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && MediaLibrary_getOwnPropSymbols)
    for (var prop of MediaLibrary_getOwnPropSymbols(source)) {
      if (exclude.indexOf(prop) < 0 && MediaLibrary_propIsEnum.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
...
const MediaLibrary = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, {
    ...
    selected,
    onSuccess: selectAll
  }), isLoading && /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null), (assetsError || foldersError) && /* @__PURE__ */ react.createElement(build.AnErrorOccurred, null), folderCount === 0 && assetCount === 0 && /* @__PURE__ */ react.createElement(EmptyAssets/* EmptyAssets */.i, {
    ...
    const _a2 = query, { _q } = _a2, queryParamsWithoutQ = __objRest(_a2, ["_q"]);
    const url = `${pathname}?${(0,lib.stringify)(MediaLibrary_spreadProps(MediaLibrary_spreadValues({}, queryParamsWithoutQ), {
      folder: folder.id
    }))}`;
  ...
  }))) : /* @__PURE__ */ react.createElement(build.NoPermissions, null))), showUploadAssetDialog && /* @__PURE__ */ react.createElement(UploadAssetDialog/* UploadAssetDialog */.x, {
